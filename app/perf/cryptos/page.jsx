  ...
  return (
    <div className="flex flex-col px-24 py-12 h-full w-full">
      ...
      <div className="text-center px-24 pb-8 text-gray-700">
        ...
        movements during notable altcoin seasons or customize your own date
        range. The table shows key statistics like price changes, trading
        volume, and market capitalization to help identify strong movers for you
        next trade.
      </div>
